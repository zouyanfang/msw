...
func (this *IndexController)Index(){
	//首页轮播图展示
	page := 1
	slideShow := services.GetDishList(page,utils.PAGESIZE3,"AND release_role = 2 AND is_slideshow = 0 ORDER BY release_date DESC",nil)
	...
	//首页菜谱列表展示
	dishShow := services.GetDishList(page,utils.PAGESIZE6,"ORDER BY release_date DESC",nil)
